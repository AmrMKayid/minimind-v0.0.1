...
def reshard(tree, shardings):
    def _make_global_arr(x, shard, shape):
        ...
        xs = [jax.device_put(x[s], device=d) for d, s in shard.addressable_devices_indices_map(shape).items()]
...
if __name__ == "__main__":
    ...
    shardings = (NamedSharding(mesh, P(("dp", "fsdp"), "tp")), NamedSharding(mesh, P(("dp", "fsdp"), "tp")))
